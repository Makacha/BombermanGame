...
public class Animation {
   ...
   * Bomber animation.
   */
  public static Animation player_default = new Animation(Sprite.player_default,
      Sprite.player_default, Sprite.player_default, Sprite.player_default_1,
      Sprite.player_default_1, Sprite.player_default_1);
   ...
   */
  // Balloom
  public static Animation balloom_left = new Animation(Sprite.balloom_left1, Sprite.balloom_left2,
      Sprite.balloom_left3);
  public static Animation balloom_right = new Animation(Sprite.balloom_right1, Sprite.balloom_right2,
      Sprite.balloom_right3);
  public static Animation balloom_dead = new Animation(Sprite.balloom_dead, Sprite.balloom_dead, Sprite.balloom_dead,
  ...
  public static Animation oneal_dead = new Animation(Sprite.oneal_dead, Sprite.oneal_dead, Sprite.oneal_dead,
      Sprite.mob_dead1, Sprite.mob_dead2, Sprite.mob_dead3);
  ...
  public static Animation doll_dead = new Animation(Sprite.doll_dead, Sprite.mob_dead1, Sprite.mob_dead2,
      Sprite.mob_dead3);
  ...
  public static Animation minvo_dead = new Animation(Sprite.minvo_dead, Sprite.mob_dead1, Sprite.mob_dead2,
      Sprite.mob_dead3);

  // Kondoria
  public static Animation kondoria_left = new Animation(Sprite.kondoria_left1, Sprite.kondoria_left2,
      Sprite.kondoria_left3);
  public static Animation kondoria_right = new Animation(Sprite.kondoria_right1, Sprite.kondoria_right2,
      Sprite.kondoria_right3);
  public static Animation kondoria_dead = new Animation(Sprite.kondoria_dead, Sprite.mob_dead1, Sprite.mob_dead2,
      Sprite.mob_dead3);
   ...
   * FlameSegment.
   */
  public static Animation bomb_exploded = new Animation(Sprite.bomb_exploded, Sprite.bomb_exploded1,
      Sprite.bomb_exploded2);
  public static Animation explosion_horizontal = new Animation(Sprite.explosion_horizontal,
      Sprite.explosion_horizontal2, Sprite.explosion_horizontal2);
  ...
  public static Animation explosion_vertical = new Animation(Sprite.explosion_vertical, Sprite.explosion_vertical1,
